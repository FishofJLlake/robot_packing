...
# 高度图分辨率（米/格）
# ============================================================
HEIGHTMAP_RESOLUTION = 0.01   # 0.5 cm per cell

# ============================================================
# 货物间隙（米） — 超参数
# ============================================================
PLACEMENT_GAP = 0.02          # 1 cm 间隙，方便实际放置
...
# 高度图局部平面拟合阈值
# ============================================================
# 用于判断高度图中的两个区域是否仍属于同一局部平面。
# 若高度差超过该阈值，则视为跨平面，应被拆成不同 plane label。
PLANE_HEIGHT_DIFF_THRESHOLD = 0.02
PLANE_SMALL_REGION_MAX_CELLS = 30
# 平面拟合门控：
# - 区域足够大且残差达标才进入拟合
# - 低倾角全量替换；高倾角弱拟合（与原值混合）以保留渐变
PLANE_FIT_REPLACE_MAX_TILT_DEG = 8.0
PLANE_FIT_MAX_RMSE = 0.02
PLANE_FIT_MIN_CELLS = 8
PLANE_FIT_SLOPE_BLEND_ALPHA = 0.35
